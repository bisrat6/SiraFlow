...
router.post('/approve/bulk', authMiddleware, employerOnly, approveBulkValidation, approvePaymentsForPeriod);
...
router.post('/retry', authMiddleware, employerOnly, approvePaymentValidation, retryPayment);
